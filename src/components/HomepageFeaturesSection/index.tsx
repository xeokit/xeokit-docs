  ...
  return (
    <section className={styles.featuresSection}>
      <div className="container">
        ...
        <div className="row margin-bottom--xl">
          <div className="col col--6">
            <img src="/img/features/computer-sourcecode.png" alt="Fully flexible and well documented JavaScript framework on top of WebGL" className={styles.featureImage} />
          </div>
          <div className="col col--6">
        ...
        <div className="row margin-bottom--xl">
          ...
          <div className="col col--6">
            <img src="/img/features/computer-gear.png" alt="CAD drawing rendered on your own server with open-source components" className={styles.featureImage} />
          </div>
        </div>
        ...
        <div className="row margin-bottom--xl">
          <div className="col col--6">
            <img src="/img/features/computer-sourcecode.png" alt="A rich programming toolkit" className={styles.featureImage} />
          </div>
          <div className="col col--6">
            ...
            <ul>
              ...
              <li><a href="https://xeokit.github.io/xeokit-sdk/docs/">Documentation</a></li>
              <li><a href="https://www.notion.so/xeokit/xeokit-Documentation-4598591fcedb4889bf8896750651f74e">Tutorials</a></li>
            </ul>
          </div>
        </div>
              ...
              <div className="row margin-bottom--lg">
                <div className="col col--6">
                  ...
                  <p className="text--center margin-top--md">
                    A bundled BIM viewer to get you started in minutes - <a href="./demo.html?projectId=OTCConferenceCenter&tab=storeys">try it out!</a>
                  </p>
                </div>
                <div className="col col--6">
                  <a href="https://xeokit.github.io/xeokit-sdk/docs/class/src/viewer/Plugin.js~Plugin.html">
                    <img src="/img/features/computer-sourcecode.png" alt="2D CAD drawing" className={styles.featureImage} />
                  </a>
                  <p className="text--center margin-top--md">
              ...
              <div className="row">
                ...
                <div className="col col--6">
                  <a href="https://xeokit.github.io/xeokit-sdk/docs/class/src/plugins/LASLoaderPlugin/LASLoaderPlugin.js~LASLoaderPlugin.html">
                    <img src="/img/features/computer-sourcecode.png" alt="Point cloud in LAS or LAZ file format rendered in web" className={styles.featureImage} />
                  </a>
                  <p className="text--center margin-top--md">
