...
# Creating 3D Model Viewers with `@xeokit/xeokit-webcomponents`
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (viewerElement) {
    ...
    observer.observe(viewerElement, { attributes: true, subtree: true, attributeFilter: [] });
    handleViewerReady();
  }
});
```
...
For more advanced features and customization, refer to the official documentation [xeokit-sdk documentation](https://xeokit.io/sdk-v2/api-doc/xeokit-sdk).
