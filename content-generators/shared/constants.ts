...
// SDK v3 examples
export const SDK_V3_FOLDER = 'sdk-v3';
export const SDK_V3_EXAMPLES_FOLDER = path.join(SDK_V3_FOLDER, 'examples');
...
export const SDK_EXAMPLES_CONTENT_DIR = path.join(ROOT_DIR, 'docs', SDK_V3_EXAMPLES_FOLDER);
