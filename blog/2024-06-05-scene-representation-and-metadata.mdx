...
We'll use an IFC model as our example, converted to XKT using [convert2xkt](/blog/2024/05/31/converting-models-to-xkt-with-convert2xkt), so that we can load it into our Viewer. This tutorial only works with convert2xkt currently.
...
> See also: [Converting Models to XKT with convert2xkt](/blog/2024/05/31/converting-models-to-xkt-with-convert2xkt)
