---
slug: dynamically-movable-model-objects
title: Dynamically Movable Model Objects
authors: [xeokit]
tags: [xeokit]
---
...
```js
import {Viewer, SceneModel} from "https://cdn.jsdelivr.net/npm/@xeokit/xeokit-sdk/dist/xeokit-sdk.es.min.js";
