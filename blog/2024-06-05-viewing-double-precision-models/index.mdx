---
slug: viewing-double-precision-models
title: Viewing Double-Precision Models
authors: [xeokit]
tags: [xeokit]
---
...
<p align="center">
![Rounding Jitter on WebGL](rounding-jitter-on-webgl.png)

*Figure 1. Rounding Jitter on WebGL - [Run this example](https://xeokit.github.io/xeokit-sdk/examples/#loading_XKT_jitter_singlePrecision_MAP)*
</p>
...
<p align="center">
![Rounding Jitter on WebGL](full-precision-emulation-in-xeokit.png)

*Figure 2. Full-Precision Emulation in xeokit - [Run this example](https://xeokit.github.io/xeokit-sdk/examples/#loading_XKT_jitter_fullPrecision_MAP)*
</p>

We can even load a second model, with IFC global coordinates centered at, say.\[-104567655, 10, 231000000\], and xeokit would happily have both of these models in the viewer, situated259038312.73units away from each other.
...
First, update your version of [xeokit-gltf-to-xkt](https://github.com/xeokit/xeokit-gltf-to-xkt) to `0.5.0` or later, assuming that you're using that within your model conversion pipeline to convert glTF models to xeokit's optimized.XKTnative geometry format.

optimized.XKTnative geometry format.
